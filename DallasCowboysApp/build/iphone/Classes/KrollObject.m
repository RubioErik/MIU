...
//@interface DallasCowboysAppObject : NSObject
//@end

@interface DallasCowboysAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[DallasCowboysAppObject class]])
		{
			for (NSString *key in [[(DallasCowboysAppObject*)o modules] allKeys])
			{

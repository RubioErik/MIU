...
/**
 Base class for all DallasCowboysApp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the DallasCowboysApp view hierarchy (such as wrapped iOS UIViews) was touched.

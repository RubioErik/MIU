...
// in simulator we redefine to format for DallasCowboysApp Developer console
...
{\
	NSString * exceptionName = [@"org.dallascowboysapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.dallascowboysapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIDallasCowboysAppNativeItemNone = -1, 
	UIDallasCowboysAppNativeItemSpinner = -2,
	UIDallasCowboysAppNativeItemProgressBar = -3,
	
	UIDallasCowboysAppNativeItemSlider = -4,
	UIDallasCowboysAppNativeItemSwitch = -5,
	UIDallasCowboysAppNativeItemMultiButton = -6,
	UIDallasCowboysAppNativeItemSegmented = -7,
	
	UIDallasCowboysAppNativeItemTextView = -8,
	UIDallasCowboysAppNativeItemTextField = -9,
	UIDallasCowboysAppNativeItemSearchBar = -10,
	
	UIDallasCowboysAppNativeItemPicker = -11,
	UIDallasCowboysAppNativeItemDatePicker = -12,
	
	UIDallasCowboysAppNativeItemInfoLight = -13,
	UIDallasCowboysAppNativeItemInfoDark = -14,
	
	UIDallasCowboysAppNativeItemDisclosure = -15,
	
	UIDallasCowboysAppNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all DallasCowboysApp instances of

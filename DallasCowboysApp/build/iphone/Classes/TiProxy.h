...
//Rare exceptions to indicate a bug in the _dallascowboysapp code (Eg, function that a subclass should have implemented)
...
/**
 The base class for DallasCowboysApp proxies.
 */

...
@interface DallasCowboysAppObject : KrollCoverageObject {
#else
@interface DallasCowboysAppObject : KrollObject {
#endif
@private
...
extern NSString * DallasCowboysApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	DallasCowboysAppObject *_dallascowboysapp;
    KrollObject* console;
	BOOL shutdown;
